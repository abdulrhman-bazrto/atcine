...
//            case C.TRACK_TYPE_AUDIO:
    ...
    public static final class TrackSelectionViewFragment extends Fragment
        ...
        public View onCreateView(
            ...
            trackSelectionView.findViewsWithText(results, "تلقائي", View.FIND_VIEWS_WITH_TEXT);
            if (results.isEmpty()) {
                trackSelectionView.findViewsWithText(results, "Auto", View.FIND_VIEWS_WITH_TEXT);
            }
            if (!results.isEmpty()) {
                results.get(0).setVisibility(View.GONE);
            }
...
//                    /* trackFormatComparator= */ null,
            ...
            for (int i = 0; i < trackSelectionView.getChildCount(); i++) {
                ...
                if (childAt instanceof AppCompatCheckedTextView){
                    ((AppCompatCheckedTextView) childAt).setCheckMarkTintList(sl);
                }
            }
