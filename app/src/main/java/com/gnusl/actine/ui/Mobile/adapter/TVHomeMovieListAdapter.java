...
public class TVHomeMovieListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TVHomeMovieListAdapter(Context context, List<Show> movies, HomeMovieClick homeMovieClick) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view;
        view = inflater.inflate(R.layout.item_tv_home_list_movie, parent, false);
...
//        }
    ...
    class MovieListViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Show movie) {
            ...
            if (!movie.getImdbRate().isEmpty()) {
                tvImdb.setText(movie.getImdbRate());
            }else {
