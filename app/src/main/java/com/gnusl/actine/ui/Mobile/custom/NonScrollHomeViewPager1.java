...
public class NonScrollHomeViewPager1 extends ViewPager {
    ...
    public NonScrollHomeViewPager1(Context context) {
        super(context);
    }

    public NonScrollHomeViewPager1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
