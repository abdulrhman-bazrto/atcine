...
public class TVMyListContainerFragment extends Fragment {

    View inflatedView;
    private Fragment mCurrentFragment;
    private Stack<Fragment> fragmentStack = new Stack<>();

    public TVMyListContainerFragment() {
    }

    public static TVMyListContainerFragment newInstance() {
        TVMyListContainerFragment fragment = new TVMyListContainerFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (inflatedView == null) {
            inflatedView = inflater.inflate(R.layout.fragment_tv_my_list_container, container, false);
            init();
        }
        return inflatedView;
    }
    ...
    private void init() {
        replaceFragment(FragmentTags.MyListFragment, null );
    }
