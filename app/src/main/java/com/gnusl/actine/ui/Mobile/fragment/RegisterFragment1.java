...
import com.gnusl.actine.ui.Mobile.activity.PaymentActivity;
import com.gnusl.actine.ui.Mobile.adapter.PaymentMethodsAdapter;
import com.gnusl.actine.ui.Mobile.adapter.PlansNewAdapter;
import com.gnusl.actine.ui.Mobile.custom.CenterLayoutManager;
import com.gnusl.actine.ui.Mobile.custom.CustomAppBarRegister;
...
public class RegisterFragment1 extends Fragment implements View.OnClickListener, ConnectionDelegate, PaymentMethodItemClickEvents {

    View inflatedView;

    private Button btnGotoStep2, btnPayment, btnLogin_;
    private View viewStep1, viewStep3, viewStepPayPal, viewSetPaymentGateway, tvChangePlan, tvChangePlan1;
    ...
    public static RegisterFragment1 newInstance(Bundle args) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (inflatedView == null) {
            inflatedView = inflater.inflate(R.layout.fragment_register1, container, false);
            init();
        }
        return inflatedView;
    }
    ...
    private void findViews() {
        ...
        Utils.setOnFocusScale(btnGotoStep2);
        Utils.setOnFocusScale(btnPayment);
        Utils.setOnFocusScale(btnLogin_);
        Utils.setOnFocusScale(tvCreditOrDebit);
        Utils.setOnFocusScale(tvPayPal);
        Utils.setOnFocusScale(tvAlreadyUser);
...
//        Toast.makeText(getActivity(), anError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onConnectionSuccess(JSONObject jsonObject) {
        ...
        if (jsonObject.has("payment_methods")) {
            ...
            PaymentMethodsAdapter paymentMethodsAdapter = new PaymentMethodsAdapter(getActivity(), paymentMethods, RegisterFragment1.this);
