...
public class CustomAppBarWithSelect extends ConstraintLayout {
    ...
    public CustomAppBarWithSelect(Context context) {
        super(context);
        mContext = context;
        init(null);
    }

    public CustomAppBarWithSelect(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }

    public CustomAppBarWithSelect(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.layout_app_bar_with_select, CustomAppBarWithSelect.this);
