...
public class TVSeriesContainerFragment extends Fragment {

    View inflatedView;
    private Fragment mCurrentFragment;
    private Stack<Fragment> fragmentStack = new Stack<>();

    public TVSeriesContainerFragment() {
    }

    public static TVSeriesContainerFragment newInstance() {
        TVSeriesContainerFragment fragment = new TVSeriesContainerFragment();
    ...
    private void init() {
        replaceFragment(FragmentTags.TVSeriesFragment, null );
    }
